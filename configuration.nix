...

{
  ...
  #boot.zfs.devNodes = "/dev/disk/by-partuuid/0db73127-6bd3-41f9-ae65-eb2a721c867a";
  #boot.zfs.forceImportAll = true;
#  boot.zfs.allowUnsupported = true;
  networking.hostId = "e0f6a94f";  # head -c4 /dev/urandom | od -An -tx4
